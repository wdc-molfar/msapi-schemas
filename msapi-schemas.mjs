...
commonjsRegister("/$$rollup_base$$/schemas/json/exchange.schema.json", function (module, exports) {
...
commonjsRegister("/$$rollup_base$$/schemas/json/queue.schema.json", function (module, exports) {
...
export { msapiSchemas as default };
